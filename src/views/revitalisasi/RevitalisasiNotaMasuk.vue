      ...
      <div class="w-full max-w-2xl rounded-2xl bg-white p-5 shadow-2xl">
        ...
        <div v-if="detailItem" class="space-y-4 text-sm text-gray-700">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div class="rounded-xl bg-gray-50 p-3"><p class="text-[10px] uppercase tracking-[0.2em] text-gray-400">Jumlah</p><p class="mt-1 font-medium text-gray-900">{{ formatRupiah(detailItem.jumlah) }}</p></div>
