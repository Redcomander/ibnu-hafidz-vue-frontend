...
const navItems = [
  ...
  { header: 'Revitalisasi SMP' },
  {
    to: "/dashboard/revitalisasi-smp",
    icon: "construction",
    label: "Ringkasan Proyek",
    roles: ['super_admin', 'admin'],
    menuKey: 'revitalisasi_smp',
    exact: true,
    activeOn: ['/dashboard/revitalisasi-smp'],
  },
  {
    to: "/dashboard/revitalisasi-smp/tukang",
    icon: "users",
    label: "Data Tukang",
    roles: ['super_admin', 'admin'],
    menuKey: 'revitalisasi_smp_tukang',
    activeOn: ['/dashboard/revitalisasi-smp/tukang'],
  },
  {
    to: "/dashboard/revitalisasi-smp/absen-tukang",
    icon: "attendance",
    label: "Absen Tukang",
    roles: ['super_admin', 'admin'],
    menuKey: 'revitalisasi_smp_absen_tukang',
    activeOn: ['/dashboard/revitalisasi-smp/absen-tukang'],
  },
  {
    to: "/dashboard/revitalisasi-smp/nota-material",
    icon: "document",
    label: "Nota Material",
    roles: ['super_admin', 'admin'],
    menuKey: 'revitalisasi_smp_nota_material',
    activeOn: ['/dashboard/revitalisasi-smp/nota-material'],
  },
  {
    to: "/dashboard/revitalisasi-smp/nota-masuk",
    icon: "document-text",
    label: "Nota Masuk",
    roles: ['super_admin', 'admin'],
    menuKey: 'revitalisasi_smp_nota_masuk',
    activeOn: ['/dashboard/revitalisasi-smp/nota-masuk'],
  },
  {
    to: "/dashboard/revitalisasi-smp/material-datang",
    icon: "package",
    label: "Material Datang",
    roles: ['super_admin', 'admin'],
    menuKey: 'revitalisasi_smp_material_datang',
    activeOn: ['/dashboard/revitalisasi-smp/material-datang'],
  },
  {
    to: "/dashboard/revitalisasi-smp/progres-pembangunan",
    icon: "trending-up",
    label: "Progres Pembangunan",
    roles: ['super_admin', 'admin'],
    menuKey: 'revitalisasi_smp_progres',
    activeOn: ['/dashboard/revitalisasi-smp/progres-pembangunan'],
  },
  { header: 'Prestasi & OCR' },
  {
